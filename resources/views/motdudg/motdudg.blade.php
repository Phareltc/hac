...
<div class="relative min-h-screen group-data-[sidebar-size=sm]:min-h-sm">
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                        <div class="xl:col-span-4">
                            <ul class="flex flex-wrap w-full gap-2 text-sm font-medium text-center filter-btns grow" data-filter-target="notes-list">
                                <li>
                                    <a href="javascript:void(0);" data-filter="all" class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear active rounded-md text-slate-500 dark:text-zink-200 border border-transparent [&.active]:bg-custom-500 dar:[&.active]:bg-custom-500 [&.active]:text-white dark:[&.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]">All</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" data-filter="business" class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent [&.active]:bg-custom-500 dar:[&.active]:bg-custom-500 [&.active]:text-white dark:[&.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]">Business</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" data-filter="social" class="inline-block px-4 py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent [&.active]:bg-custom-500 dar:[&.active]:bg-custom-500 [&.active]:text-white dark:[&.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]">Social</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="xl:col-start-10 xl:col-span-3">
                            <div class="flex">
                                <div class="shrink-0">
                                    <button data-modal-target="addNotesModal" type="button" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i data-lucide="plus" class="inline-block size-4"></i> <span class="align-middle">Add Note</span></button>
                                </div>
                            </div>
                        </div><!--end col-->
    ...
    <div id="addNotesModal" modal-center="" aria-labelledby="addNewNoteLabel" class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show">
        <div class="w-screen xl:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-5 border-b dark:border-zink-500">
                <h5 class="text-16" id="addNewNoteLabel">Add Motdudg</h5>
                <button data-modal-close="addNotesModal" id="notesModal-close" class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500">
                    <i data-lucide="x" class="size-5"></i>
                </button>
            </div>
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-5">
                <form novalidate="" class="create-form" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                        <div class="xl:col-span-4">
                            <label for="dgInput" class="inline-block mb-2 text-base font-medium">À propos du DG</label>
                            <textarea id="dgInput" name="dg" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="À propos du Directeur Général" rows="6"></textarea>
                        </div>
                        <div class="xl:col-span-4">
                            <label for="missionInput" class="inline-block mb-2 text-base font-medium">Missions</label>
                            <textarea id="missionInput" name="missions" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Missions de l'entreprise" rows="6"></textarea>
                        </div>
                        <div class="xl:col-span-4">
                            <label for="visionsInput" class="inline-block mb-2 text-base font-medium">Visions</label>
                            <textarea id="visionsInput" name="visions" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Visions de l'entreprise" rows="6"></textarea>
                        </div>
                        <div class="xl:col-span-4">
                            <label for="visionsInput" class="inline-block mb-2 text-base font-medium">description</label>
                            <textarea id="descriptionInput" name="description" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="description de l'entreprise" rows="6"></textarea>
                        </div>
                        <div class="xl:col-span-8">
                            <label for="photoInput" class="inline-block mb-2 text-base font-medium">Photo</label>
                            <input type="file" id="photoInput" name="photo" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" accept="image/*">
                        </div>
                    </div>

                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="addNotesModal" class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-600 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10">Cancel</button>
    ...
    <div id="overviewNotesModal" modal-center="" class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
        <div class="w-screen xl:w-[35rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-5 border-b dark:border-zink-500">
                <div class="flex items-center gap-2">
                    <div class="relative dropdown">
                        <button class="mt-1 border border-dashed rounded-full size-4 dropdown-toggle shrink-0 bg-sky-100 border-sky-500 dark:bg-sky-500/20" id="notesAction1" data-bs-toggle="dropdown"></button>
                ...
                <button data-modal-close="overviewNotesModal" class="transition-all duration-200 ease-linear text-slate-500 hover:text-red-500 dark:text-zink-200 dark:hover:text-red-500"><i data-lucide="x" class="size-5"></i></button>
            </div>
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-5">
                <div class="flex items-center gap-2 mb-4">
                    <h6 class="text-sm font-normal grow"><i data-lucide="user-2" class="inline-block mr-1 align-middle size-4 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500"></i>
                        <span class="align-middle">Admin</span>
                    </h6>
                    <h6 class="text-sm font-normal shrink-0"><i data-lucide="calendar" class="inline-block mr-1 align-middle size-4 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500"></i>
                        <span class="align-middle">21 Sept, 2023</span>
                    </h6>
                </div>
                <p class="mb-2 text-slate-500 dark:text-zink-200">Every vacation has its own special vibe and it all
                    starts with where you stay.</p>
                <p class="mb-2 text-slate-500 dark:text-zink-200"> We present you with an ever growing exclusive
                    collection of private residences, meticulously hand picked and personally inspected to the tee to
                    fit almost every interest in popular travel destinations. These residences are aided with a Pre
                    Rental Advisor with first hand knowledge of these properties and their surrounding.</p>
                <p class="text-slate-500 dark:text-zink-200">Local people define a holiday, are principally warm,
                    caring, ethical and well-intentioned. All this a mere phone call or click away, backed by the
                    expertise of a decade old reputed company, inspiring you to live life's best moments more easily and
                    often than you ever thought possible.</p>
                <div class="flex justify-end gap-2 mt-4">
                    <button data-modal-close="overviewNotesModal" class="text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-600 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10">Cancel</button>
                    <button data-modal-target="addNotesModal" data-modal-close="overviewNotesModal" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Edit
                        Note</button>
                </div>
            </div>
        </div>
